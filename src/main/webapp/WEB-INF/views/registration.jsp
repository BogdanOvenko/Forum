...
<head>
    ...
    <link rel="stylesheet"  href="<spring:url value="/resources/bootstrap/css/bootstrap.css"/>">
...
<form:form method="post" action="/registration" modelAttribute="newUser" class="form-signin">
    ...
    <form:input class="input-block-level" type="text" path="name" placeholder="your login"/><br>
