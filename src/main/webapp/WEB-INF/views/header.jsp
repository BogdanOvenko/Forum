...
<head>
    ...
    <!-- Bootstrap core CSS -->
   <%-- <link href="<c:url value ="/WEB-INF/resources/bootstrap/css/bootstrap.min.css"/>" rel="stylesheet">


    <!-- Custom styles for this template -->
    <link href="<c:url value ="/WEB-INF/resources/bootstrap/css/cover.css"/>" rel="stylesheet">--%>
